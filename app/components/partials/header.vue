<template>
  <header class="flex items-center py-4 md:py-8">
    <div class="header__logo">
      <nuxt-link to="/">
        <img :src="logo" alt="Logo" /> <h1>dEngine</h1>
      </nuxt-link>
    </div>
    ...
    <nav class="nav ml-auto">
      <ul class=" flex flex-row items-center sm:mt-4 sm:pt-4 md:mt-0 md:pt-0 md:mr-4 lg:mr-8">
        <li>
          <a href="https://github.com/rihp/dEngine/blob/master/dEngine_LitePaper.pdf" class="block font-medium px-4 py-1 md:p-2 lg:px-4">
            Lite Paper
          </a>
        </li>
